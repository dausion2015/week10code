...
upsample_filter_tensor_x2_2 = tf.Variable(upsample_filter_np_x2_2,name='vgg_16/upsampled_logits_pool4/t_conv_x2')
...
upsample_filter_tensor_x8 = tf.Variable(upsample_filter_np_x8,name='vgg_16/upsampled_logits_pool3/t_conv_x8')
